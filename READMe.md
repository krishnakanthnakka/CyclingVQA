...
[Krishna Kanth Nakka](https://krishnakanthnakka.github.io/) and Vedasri Nakka* 

**Munich, Bavaria, Germany**

[![paper](https://img.shields.io/badge/arXiv-Paper-blue.svg)](https://arxiv.org/abs/2602.10771)
[![Website](https://img.shields.io/badge/Project-Website-87CEEB)](https://krishnakanthnakka.github.io/CyclingVQA/)
[![HuggingFace](https://img.shields.io/badge/HuggingFace-CyclingVQA-FFD21E)](https://huggingface.co/datasets/KKNakka/CyclingVQA)
...
@article{nakka2025mammo,
  ...
  author={Nakka, Krishna Kanth and Nakka, Vedasri},
  journal={arXiV},
  year={2026}
}
```
...
## Contact Details
- If you require early access to the dataset, please write to krishkanth.92@gmail.com